...
| Full content import | Page body content is present in the wiki, not just a source link or summary. | In progress |
...
| 04 | Symptom Sorter | `docs/pharmacy-practice/symptom-sorter/` | Partial | 37 pages imported | Partial | Pending | Pending |
...
Batch 04 standalone import now includes 37 symptom pages. Remaining symptom-level pages must be imported as local content pages, with local links and anchor checks.

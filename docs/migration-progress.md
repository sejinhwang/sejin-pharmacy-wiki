...
| 04 | Symptom Sorter | `docs/pharmacy-practice/symptom-sorter/` | Partial | 47 pages imported | Partial | Pending | Pending |
...
Batch 04 standalone import now includes 47 symptom pages. Remaining symptom-level pages must be imported as local content pages, with local links and anchor checks.

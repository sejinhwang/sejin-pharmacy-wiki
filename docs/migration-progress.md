...
| 04 | Symptom Sorter | `docs/pharmacy-practice/symptom-sorter/` | Partial | 3 pages imported | Partial | Pending | Pending |
...
Batch 04 standalone import started with acute abdominal pain in adults, acute confusion, and cough in adults. Remaining symptom-level pages must be imported as local content pages, with local links and anchor checks.
